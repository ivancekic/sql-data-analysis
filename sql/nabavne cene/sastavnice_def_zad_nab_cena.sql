select sz.broj_dok s_brd, sz.proizvod s_pro, p.naziv s_pro_naz, sz.kolicina s_kol, sz.jed_mere s_jm--, p.jed_mere p_pjm
     , ss.proizvod st_pro, p1.naziv st_pro_naz, ss.kolicina st_kol, ss.jed_mere st_jm, ss.za_trebovanje st_tr, ss.SKART st_skart

     , round(znc.KOL_SKLAD,5) znc_kol_sklad, znc.cena znc_cena, znc.rabat znc_rab_proc, znc.RabIznos znc_Rab_Iznos,znc.CENASARAB znc_cena_sa_rab
     , znc.Z_TROSKOVI znc_ztro, znc.CENAZTRO znc_cena_sa_ztro
...
--and sz.jed_mere <> p.jed_mere
  ...
  and ss.proizvod = znc.proizvod (+)
Order by to_number(sz.broj_dok)
