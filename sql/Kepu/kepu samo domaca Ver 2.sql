...
----	                	                                	     	 when vd3.za_vrsta_dok in (11,12,31,74) then 1
	                             ...
	                             *
	                             ...
	                             ROUND(
--	                                    sign(ST.K_ROBE) * st.k_robe *
	                                    st.kolicina * ( st.cena - NVL(round(st.cena1 * st.faktor,4),0))
...
--
--						                                         * (CASE WHEN NVL(ST.FAKTOR,1) >= 1 THEN
--					                                                          1/NVL(ST.FAKTOR,1)
--						                                            ELSE
--					                                                          NVL(ST.FAKTOR,1)
--						                                            END
...
--                                    (st.cena - round(st.cena1*st.faktor,4))
--                                  * st.rabat/100
...
--                               round(
--                                      sign(ST.K_ROBE) * st.k_robe *
--                                     st.kolicina * ( st.cena - NVL(round(st.cena1 * st.faktor,4),0)) * nvl(st.rabat,0) /100
--                                     * PDokument.ZokiUlazIzlaz(d.vrsta_dok,d.tip_dok,st.K_ROBE,'P',d.datum_dok)
--
--                                     ,2)
--                   else
