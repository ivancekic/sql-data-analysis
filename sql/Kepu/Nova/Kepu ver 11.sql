...
--                             case when vd_niv_stav.za_vrsta_dok IN (11,12) then
...
--                                       ROUND(d.kolicina*(NVL(d.cena,0)-NVL(round(d.cena1*d.faktor,4),0))*D.K_ROBE,2)
                    WHEN D.VRSTA_DOK = '90' and nvl(d.cena,0) = NVL(round(d.cena1*d.faktor,4),0) THEN
                                       0
               Else
