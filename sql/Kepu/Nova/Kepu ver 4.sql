--Select d4.DODATNI_TIP,d4.BROJ_DOK,d4.GOD_DOK,d4.VRSTA_DOK,d4.STRANICA,d4.REDBRSTAVKE,d4.DATUM,d4.DATUM_DOK
--       , d4.DOKUMENT,d4.NAZIV_PARTNERA,d4.DATUM_UNOSA,d4.TIP_DOK,d4.ORG_DEO,d4.BROJ_DOK1,d4.PPARTNER,d4.PO_DOKUMENTU
--       , d4.ST_BRD,d4.ST_VRD,d4.ST_GOD
--From
--(
Select
...
,(
   Select sd.*
   From stavka_dok sd, dokument d5
   Where d5.broj_dok !='0'
     and d5.godina != 0
     and d5.org_deo = &vZa_Magacin
     and d5.datum_dok between  &DatumPocetnogStanja and &dDatumDo
     and d5.STATUS > 0
     and d5.godina = sd.godina and d5.vrsta_dok = sd.vrsta_dok and d5.broj_dok = sd.broj_dok
     and (k_robe<> 0 or d5.vrsta_Dok='80')
 ) sd
Where d.godina = vd_prij.godina (+) and d.vrsta_dok = vd_prij.vrsta_dok (+) and d.broj_dok = vd_prij.broj_dok (+)
  ...
  and d.godina = sd.godina and d.vrsta_dok = sd.vrsta_dok and d.broj_dok = sd.broj_dok
--and d.vrsta_Dok = '90'
Group by ROWNUM, DODATNI_TIP,d.BROJ_DOK,d.GODINA,d.VRSTA_DOK,d.DATUM_DOK
--       , DOKUMENT
       , NAZIV_PARTNERA,DATUM_UNOSA,TIP_DOK,ORG_DEO,BROJ_DOK1,PPARTNER
--       ,PO_DOKUMENTU
--       ,ST_BRD,ST_VRD,ST_GOD
       , vd_prij.za_broj_dok
       , vd_prij_tr.za_broj_dok, vd_prij_tr.za_godina
       , vd_niv_stav.za_broj_dok, vd_niv_stav.za_vrsta_dok, vd_niv_stav.za_godina
       , vd_niv_stav_mag, vd_niv_stav_brd1
       , vd_pov_otp_mag, vd_pov_otp_brd1, vd_pov_otp.za_godina

       , vd_pov_prij_mag, vd_pov_prij_brd1, vd_pov_prij.za_godina

order by d.org_deo,d.datum_dok,d.datum_unosa
--) d4
--order by d4.org_deo,d4.datum_dok,d4.datum_unosa
--
