select d.DODATNI_TIP,d.BROJ_DOK,d.GOD_DOK,d.VRSTA_DOK,d.STRANICA,d.REDBRSTAVKE,d.DATUM,d.DATUM_DOK
...
, SD.PROIZVOD, sd.kolicina, sd.cena, sd.valuta, sd.faktor, sd.rabat, sd.cena1
	--     , SD.PROIZVOD
	...
	--                             case when st_vrd=13 then
	--                                       -1 * ROUND(sd.kolicina*(NVL(sd.cena,0)-NVL(sd.cena1,0)),2)
	--                             else
