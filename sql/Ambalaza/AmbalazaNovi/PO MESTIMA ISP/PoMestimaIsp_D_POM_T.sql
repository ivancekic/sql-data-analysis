...
Cursor MOJ_cur IS
    Select pp.teren, obl.naziv naziv_ter,
	       pp.sifra, pp.naziv naziv_partner,NVL(D.PP_ISPORUKE,pp.sifra) PP_ISPORUKE,
...
--                       )
                       decode((Select d1.mesto_isporuke
                               ...
                               and d1.Vrsta_Dok = vd.za_Vrsta_Dok And d1.Broj_Dok = vd.za_Broj_Dok And d1.Godina = vd.za_Godina
                                      ...
                                      Where vd4.godina = d.godina and vd4.vrsta_dok = d.vrsta_dok and vd4.broj_dok = d.broj_dok
	...
	Group By pp.teren, obl.naziv, pp.sifra, pp.naziv,D.PP_ISPORUKE,
	         d.Godina, d.vrsta_dok, d.broj_dok, d.tip_dok, sd.Proizvod, P.Naziv, Mesto_isporuke, P.Jed_Mere
