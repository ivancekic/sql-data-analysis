...
WHERE vd.VRSTA_DOK in ( 11 , 24 )
  AND vd.ZA_VRSTA_DOK in (11,12,13,31,61,62)
  and (d.vrsta_dok ||','||d.tip_dok) in (select '11,23' from dual) -- interne otpremnice

  --  veza tabela
  and vd.godina    = d.godina
  and decode(vd.vrsta_dok,24,11,11) = d.vrsta_dok
