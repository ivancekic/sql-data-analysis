select
D.godina, d.vrsta_dok vr, pvrstadok.naziv(d.vrsta_dok) naziv ,d.broj_dok, d.tip_dok tip, pnacinfakt.naziv(d.tip_dok) naziv,
...
Where sd.godina    (+)= d.godina and sd.vrsta_dok (+)= d.vrsta_dok and sd.broj_dok  (+)= d.broj_dok
  ...
  and d.godina = 2007 and d.vrsta_Dok = 3 and d.broj_dok = 
