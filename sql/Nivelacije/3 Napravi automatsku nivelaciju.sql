DECLARE
  nGodinaDok        Number      := 2013;
  cBrojDok          Varchar2(9) := '2';
  nOrgDeo           NUMBER      := '1085';
  ...
  Cursor ZaNiv_cursor Is
	select
	DISTINCT d.broj_dok1,d.BROJ_DOK, d.VRSTA_DOK, d.GODINA, d.datum_dok, d.datum_unosa , d.org_deo, d.user_id
	from dokument d, stavka_dok sd
	where d.godina = nGodinaDok
--	  and d.vrsta_Dok in (11,12,13,31)
	  and d.vrsta_Dok in (11,12,13,31,74)
--	  and d.broj_dok in ('804','817')
